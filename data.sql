...
-- reviewsテーブル
INSERT IGNORE INTO reviews (house_id, user_id, rating, comment) VALUES 
(1, 1, 5, '素晴らしい滞在でした！家は清潔で広々としていました。'),
(1, 2, 4, '快適な場所でしたが、夜は少し騒がしかったです。'),
(2, 3, 3, '普通でした。立地がもう少し良ければと思います。'),
(3, 4, 2, '清掃が行き届いていませんでしたが、スタッフは親切でした。'),
(3, 5, 5, '最高の体験！また来たいと思います。'),
(4, 6, 4, '素敵な場所ですが、少し値段が高い気がしました。'),
(5, 7, 5, '家族旅行に最適でした。とてもお勧めです！'),
(5, 8, 3, '平均的な滞在でした。メンテナンスがもう少し必要です。'),
(6, 9, 1, '最悪の体験でした。お勧めできません。'),
(7, 10, 5, '今までで最高の宿泊！期待以上でした。'),
(8, 11, 4, '快適で便利な場所でした。短期滞在に最適です。');
